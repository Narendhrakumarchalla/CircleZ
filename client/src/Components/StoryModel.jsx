...
const StoryModel = ({setShowModal, fetchStories}) => {
    ...
    const bgColors = ["#ffebee", "#ffcdd2", "#ef9a9a", "#e57373", "#ef5350", "#f44336", "#e53935", "#d32f2f", "#c62828"];
        ...
        <div className='w-full max-w-md'>
            ...
            <div className='flex gap-2 mt-4'>
                ...
                <label className={`flex-1 flex items-center justify-center gap-2 p-2 rounded cursor-pointer ${mode === 'media' ? "bg-white text-black" : "bg-zinc-800"}`} >
                    ...
                    accept='image/*, video/*'
                    className='hidden'
                    onChange={(e)=> {hanldeUploadMedia(e); setMode("media")}}
                    />
            ...
            className='flex items-center justify-center gap-2 text-white py-3 mt-4 w-full rounded bg-gradient-to-r from-indigo-500 to-purple-600 hove:from-indigo-600 hove:to-purlpe-700 active:scale-95 transition cursor-pointer' >
