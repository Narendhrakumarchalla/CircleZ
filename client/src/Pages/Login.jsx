...
const Login = () => {
  return (
    <div className='min-h-screen flex flox-col md:flex-row'>
      {/* BackGround Image */}
      <img src={assets.bgImage} className='absolute top-0 left-0 -z-1 object-cover w-full h-full' />
      ...
      <div className='flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40'>
        ...
        <div>
          ...
          <p className='text-xl md:text-3xl text-indigo-900 max-w-72 md:max-w-md'>Connect with global community on CirclZ.</p>
        </div>
