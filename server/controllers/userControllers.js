...
const updateUserData = async (req, res) => {
    try {
        ...
        if(tempUser.username !== username){
            ...
            if(existingUser){
                username = tempUser.username; // Revert to old username if new one already exists
            }
        }
...
const unFollowUser = async (req, res)=>{
    try {
        ...
        followedUser.followers = followedUser.followers.filter(user=> user !== userId);
        await followedUser.save();
...
export { getUserData, updateUserData, discoverUsers, followUser, unFollowUser, requestConnection, getUserConnections, acceptConnection, getUserProfiles };